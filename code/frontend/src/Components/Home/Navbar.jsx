      ...
      <div className="nav__container">
        <div className="nav__header">
          <div className="nav__logo">
            <img src="../assets/codehub-logo.png" alt="CodeHub Logo" />
            <Link to="/">
              <span className="logo__text">CodeHub</span>
            </Link>
          </div>
          
          <div className="nav__search">
            <form>
              <input type="text" placeholder="Search tutorials, libraries, projects..." />
        ...
        <ul className={`nav__links ${menuOpen ? "open" : ""}`}>
          <li className="nav__item">
            <Link to="/tutorials" className="nav__link">Tutorials</Link>
          </li>
          <li className="nav__item">
            <Link to="/projects" className="nav__link">Projects</Link>
          </li>
          <li className="nav__item">
            <Link to="/tools" className="nav__link">Tools</Link>
          </li>
          <li className="nav__item">
          ...
          <li className="nav__item nav__item--cta">
            {isLoggedIn ? (
              ...
              <Link to="/get-started" className="nav__link nav__link--cta">Start Coding</Link>
            )}
          </li>
        </ul>
